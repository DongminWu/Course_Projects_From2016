...
% 1. nowadays situatio of applying deep learning

% 1.1  The wide variety of deep learning technology

Since the idea of Deep learning, the applying of this algorithm increased obviously.
The variety and numbers of Deep learning application are large. 


% 1.2  Type of problem that can be resolved by Deep learning 



% 2. Current situation of using deep learning in Mobile devices.
